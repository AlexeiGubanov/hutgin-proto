...
import static com.hutgin2.dao.search.ISearch.*;
...
public class SearchUtil {
    ...
    public static IMutableSearch shallowCopy(ISearch source, IMutableSearch destination) {
        destination.setEntityName(source.getEntityName());
    ...
    public static boolean equals(ISearch search, Object obj) {
        ...
        if (search.getEntityName() == null ? s.getEntityName() != null : !search.getEntityName().equals(
                s.getEntityName()))
            return false;
    ...
    public static int hashCode(ISearch search) {
        int hash = 1;
        hash = hash * 31 + (search.getEntityName() == null ? 0 : search.getEntityName().hashCode());
    ...
    public static String toString(ISearch search) {
        ...
        sb.append(search.getEntityName());

...
/**
 * Kind of hack
 * {@link org.hibernate.metamodel.source.binder.Binder}
 * TODO review
 */
public class DMBinder {
    ...
    public DMBinder(MetadataImplementor metadata, List<String> processedEntityNames) {
    ...
    private void bindCollectionTable(
        ...
        final Schema.Name schemaName = org.hibernate.metamodel.source.hbm.Helper.determineDatabaseSchemaName(
    ...
    private BasicAttributeBinding doBasicSingularAttributeBindingCreation(
        ...
        attributeBinding.setPropertyAccessorName(
                org.hibernate.metamodel.source.hbm.Helper.getPropertyAccessorName(
    ...
    private Table createTable(EntityBinding entityBinding, TableSource tableSource) {
        ...
        final Schema.Name databaseSchemaName = org.hibernate.metamodel.source.hbm.Helper.determineDatabaseSchemaName(

...
import com.hutgin2.dao.hibernate.MetaMappingBinder2;
import com.hutgin2.dao.hibernate.binder.SingularAttributeSourceImpl;
import com.hutgin2.meta.ConstraintIDXMeta;
    ...
    private void resolveAndBindTypeDef(SimpleValue simpleValue, Mappings mappings, String typeName, Properties parameters) {
        ...
        if (typeDef != null) {
            ...
            if (basicType == null) {
				 ...
				 */
                SecondPass resolveUserTypeMappingSecondPass = new MetaMappingBinder2.ResolveUserTypeMappingSecondPass(simpleValue, typeName, mappings, parameters);
